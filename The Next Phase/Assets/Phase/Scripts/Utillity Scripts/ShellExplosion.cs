...
{
    public LayerMask targetMask;                      // Used to filter what the explosion affects, this should be set to "targets".
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        for (int i = 0; i < colliders.Length; i++)
        {
            ...
            targetHealth.TakeDamage((int)damage, transform.position);
        }
